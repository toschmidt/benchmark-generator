...
def parse_arguments():
    ...
    parser.add_argument('--in', type=str, help='json input file for generating the schema or the benchmark')
    parser.add_argument('--out', type=str, help='path to the cpp or json schema output file')
...
def main():
    ...
    #generate_schema('./test.json', './test-schema.json')
    generate_benchmark('./test/benchmark.json', './test/benchmark.cpp')
